  ...
  return (
    <Card>
      ...
      <CardContent className="pt-0">
        {error && (
          <div className="mb-3 rounded border border-ringing/40 bg-ringing-tint p-2 text-xs text-ringing-ink">
            {error}
          </div>
        )}
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-2 gap-3">
            {metrics.map((item, idx) => (
              <div key={idx} className="flex items-center gap-2 rounded-lg bg-sunken p-3">
                <div
