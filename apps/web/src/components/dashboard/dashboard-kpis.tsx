...
export function DashboardKPIs({ dateRange, onFilterChange, campaignId }: DashboardKPIsProps) {
  ...
  return (
    <div className="space-y-4">
      {error && (
        <div className="rounded-lg border border-ringing/40 bg-ringing-tint p-3 text-sm text-ringing-ink">
      ...
      <div className="grid gap-4 grid-cols-2 lg:grid-cols-5">
        ...
        <div
          className={cn(
            'relative overflow-hidden rounded-card border p-5 transition-all duration-200',
            isHighAlert
              ? 'bg-dropped-tint border-dropped shadow-lg'
        ...
        >
          ...
          <div className="relative z-10 space-y-3">
            ...
            <div className="flex items-center justify-between">
              ...
              {isHighAlert ? (
                <AlertTriangle className="h-4 w-4 text-dropped-ink animate-pulse" />
              ) : (
              ...
              {loading ? (
                ...
                <span
                  className={cn(
                    ...
                    isHighAlert ? 'text-dropped-ink' : 'text-foreground'
                  )}
                >
            ...
            {!loading && (
              <div className="flex items-center gap-2">
                {isHighAlert && (
                  <span className="text-xs font-medium text-dropped-ink">
                    {missedPercentage > 30
