...
import { WhereCallsWent } from '@/components/white-label/where-calls-went';
 ...
 */
export function SalesView(): JSX.Element {
  ...
  return (
    <div className="page-canvas">
      ...
      <PeriodToolbar state={state} resolved={data?.period ?? null} label="Revenue period" />
...
function SalesBody({ data }: { data: CallSalesSummary }): JSX.Element {
  ...
  return (
    <>
      ...
      <WhereCallsWent
        inbound={data.totals.inboundCalls}
        disposition={data.disposition}
        agentsHref={leaderboardHref}
      />
