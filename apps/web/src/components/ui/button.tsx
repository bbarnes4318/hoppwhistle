...
const buttonVariants = cva(
  [
    ...
    // Colour eases in on hover only. A disabled button re-enabling (a form
    // after a refused sign-in) switches instantly: easing from the sunken
    // disabled fill to the brand fill passes through ~1.1:1 text on the way.
    'transition-shadow duration-150 ease-out enabled:hover:transition-[color,background-color,border-color,box-shadow] ne-motion',
