...
export function CustomerIntakeForm(): JSX.Element {
  ...
  return (
    <div className="space-y-6 p-4 bg-sunken rounded-lg border border-rule">
      {/* ═══════════════════════════════════════════════════════════════════ */}
      ...
      <section>
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="text-lg font-semibold text-ink">Lead Information</h3>
          <span className="text-xs text-ink-2 ml-2">(Required)</span>
        </div>
        ...
        <div className="grid grid-cols-5 gap-4">
          ...
          <div className="space-y-1.5">
            <Label htmlFor="firstName" className="text-ink-2">
              First Name <span className="text-dropped-ink">*</span>
            </Label>
            <Input
              id="firstName"
          ...
          <div className="space-y-1.5">
            <Label htmlFor="lastName" className="text-ink-2">
              Last Name <span className="text-dropped-ink">*</span>
            </Label>
            <Input
              id="lastName"
          ...
          <div className="space-y-1.5">
            <Label htmlFor="phone" className="text-ink-2">
              Phone <span className="text-dropped-ink">*</span>
            </Label>
            <Input
              id="phone"
          ...
          <div className="space-y-1.5">
            <Label htmlFor="state" className="text-ink-2">
              State <span className="text-dropped-ink">*</span>
            </Label>
          ...
          <div className="flex items-center gap-3">
            {!showFullApplication && (
              <Button
                ...
                className="border-brand text-brand-ink hover:bg-brand-tint hover:border-brand"
              >
          ...
          {!showFullApplication && (
            <div className="flex items-center gap-3">
              <Button
                ...
                className="border-rule-strong text-ink-2 hover:text-ink hover:border-rule-strong"
              >
                Clear
              </Button>
              <Button
            ...
            <div
              className={`flex items-center gap-2 text-sm p-3 rounded-lg ${
                submitStatus === 'success'
                  ? 'bg-live-tint text-live-ink border border-live'
                  : 'bg-dropped-tint text-dropped-ink border border-dropped'
              }`}
            >
        ...
        <>
          ...
          <section className="border-t border-rule pt-6">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-lg font-semibold text-ink">Additional Details</h3>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div className="space-y-1.5">
                ...
                <Input
                  ...
                  className={`bg-sunken border-rule-strong text-ink ${
                    formData.email && !isValidEmail(formData.email) ? 'border-dropped' : ''
                  }`}
              ...
              {/* Date of Birth */}
              <div className="space-y-1.5">
                <Label htmlFor="dateOfBirth" className="text-ink-2">
                  Date of Birth
                </Label>
                <Input
                  id="dateOfBirth"
              ...
              {/* State of Birth */}
              <div className="space-y-1.5">
                <Label htmlFor="stateOfBirth" className="text-ink-2">
                  State of Birth
                </Label>
                <Select
            ...
            <div className="grid grid-cols-4 gap-4 mt-4">
              ...
              <div className="space-y-1.5">
                <Label htmlFor="zip" className="text-ink-2">
                  Zip
                </Label>
                <Input
                  id="zip"
          ...
          <section className="border-t border-rule pt-6">
            <div className="flex items-center gap-2 mb-4">
              <Shield className="h-5 w-5 text-live-ink" />
              <h3 className="text-lg font-semibold text-ink">Policy Details</h3>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <div className="flex justify-between">
                  <Label className="text-ink-2">Coverage Amount</Label>
                  <span className="text-lg font-bold text-live-ink">
              ...
              <div className="grid grid-cols-4 gap-4 mt-4">
                <div className="flex items-center gap-3 p-3 bg-sunken rounded-lg">
                  ...
                  />
                  <Label className="text-ink-2 cursor-pointer">Tobacco User</Label>
                </div>
                <div className="flex items-center gap-3 p-3 bg-sunken rounded-lg">
                  <Switch
                  ...
                  />
                  <Label className="text-ink-2 cursor-pointer">SS Payment</Label>
                </div>
                <div className="space-y-1.5">
                  <Label className="text-ink-2">SS Pay Day</Label>
                  <Select
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div className="space-y-1.5">
                    <Label className="text-ink-2 text-xs">1st Pay Day</Label>
                    <Select
                      value={formData.firstPayDay?.toString() || ''}
                      onValueChange={value => updateField('firstPayDay', parseInt(value, 10))}
                    >
                      <SelectTrigger className="bg-sunken border-rule-strong text-ink h-9 text-sm">
                  ...
                  <div className="space-y-1.5">
                    <Label className="text-ink-2 text-xs">Future Pay</Label>
                    <Select
          ...
          <section className="border-t border-rule pt-6">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-lg font-semibold text-ink">Beneficiaries</h3>
              </div>
              <Button
                variant="outline"
                size="sm"
                onClick={handleAddBeneficiary}
                className="border-brand text-brand-ink hover:bg-brand-tint"
              >
            ...
            <div className="space-y-3">
              {formData.primaryBeneficiaries.map((beneficiary, index) => (
                <div
                  key={beneficiary.id}
                  className="flex items-center gap-3 p-3 bg-sunken rounded-lg"
                >
                  <span className="text-ink-3 text-sm w-6">#{index + 1}</span>
                  <Input
                    value={beneficiary.name}
                    onChange={e => handleUpdateBeneficiary(beneficiary.id, 'name', e.target.value)}
                    className="flex-1 bg-sunken border-rule-strong text-ink"
                  ...
                  >
                    <SelectTrigger className="w-36 bg-sunken border-rule-strong text-ink">
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
                  ...
                  <Button
                    ...
                    className="text-dropped-ink hover:text-dropped-ink hover:bg-dropped-tint"
                  >
              ...
              {formData.primaryBeneficiaries.length === 0 && (
                <div className="text-center py-6 text-ink-3 bg-sunken rounded-lg">
            ...
            <div className="grid grid-cols-2 gap-4 mt-4">
              <div className="space-y-1.5">
                <Label className="text-ink-2">Secondary Beneficiary Name</Label>
                <Input
              ...
              <div className="space-y-1.5">
                <Label className="text-ink-2">Relationship</Label>
                <Select
          ...
          <section className="border-t border-rule pt-6">
            <div className="flex items-center gap-2 mb-4">
              <CreditCard className="h-5 w-5 text-ringing-ink" />
              <h3 className="text-lg font-semibold text-ink">Banking Information</h3>
            </div>

            <div className="grid grid-cols-3 gap-4">
              <div className="space-y-1.5">
                <Label htmlFor="nameOnAccount" className="text-ink-2">
                  Name on Account
                </Label>
                <Input
                  id="nameOnAccount"
              ...
              <div className="space-y-1.5">
                <Label htmlFor="bankName" className="text-ink-2">
                  Bank Name
                </Label>
                <Input
                  id="bankName"
              ...
              <div className="space-y-1.5">
                <Label className="text-ink-2">Account Type</Label>
                <Select
            ...
            <div className="grid grid-cols-3 gap-4 mt-4">
              <div className="space-y-1.5">
                <Label htmlFor="routingNumber" className="text-ink-2">
                  Routing Number
                </Label>
                <Input
                  id="routingNumber"
              ...
              <div className="space-y-1.5">
                <Label htmlFor="accountNumber" className="text-ink-2">
                  Account Number
                </Label>
                <Input
                  id="accountNumber"
              ...
              <div className="space-y-1.5">
                <Label htmlFor="ssn" className="text-ink-2">
                  SSN
                </Label>
                <div className="relative">
                  <Input
                    ...
                    className="bg-sunken border-rule-strong text-ink pr-16"
                  ...
                  <Button
                    ...
                    className="absolute right-1 top-1/2 -translate-y-1/2 text-xs text-ink-2 hover:text-ink"
                  >
                    {showSSN ? 'Hide' : 'Show'}
                  </Button>
                </div>
      ...
      {/* ═══════════════════════════════════════════════════════════════════ */}
      {submittedCertUrl && (
        <section className="mt-6 p-4 bg-live-tint border border-live rounded-lg">
          <div className="flex items-center gap-2 mb-2">
            <FileText className="h-5 w-5 text-live-ink" />
            <h3 className="text-lg font-semibold text-live-ink">TrustedForm Certificate</h3>
          </div>
          <div className="flex items-center gap-2 mt-2">
            <code className="flex-1 text-xs bg-sunken text-ink-2 p-2 rounded font-mono overflow-x-auto">
              {submittedCertUrl}
            </code>
            <a
              ...
              className="inline-flex items-center gap-1 px-3 py-2 text-sm bg-brand hover:bg-brand-ink hover:text-surface text-ink rounded"
            >
