...
const RetentionScriptPanel = ({ prospectData, onDataUpdate }: RetentionScriptPanelProps) => {
  ...
  return (
    <div className="h-full flex flex-col overflow-auto bg-[#0a0a0f]">
      {/* Header Banner */}
      <div className="bg-gradient-to-r from-purple-600/20 to-violet-600/20 border-b border-purple-500/30 p-4 flex-shrink-0">
      ...
      {/* Customer Info Bar */}
      {prospectData && (
        <div className="bg-[#13131a] border-b border-[#2e2e3e] p-3 flex items-center gap-4 flex-shrink-0">
      ...
      <div className="flex-1 p-6 overflow-auto">
        ...
        <div className="space-y-4">
          <div className="bg-[#1e1e2e] rounded-xl p-5 border border-[#2e2e3e]">
