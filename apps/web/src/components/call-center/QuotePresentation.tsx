...
export function ThreeOptionQuoteDisplay({
 ...
 {/* Selection Summary */}
 {selectedOption && (
 <div className="bg-primary border border-emerald-500/20 rounded-lg p-4 mt-4">
...
export function CarrierConfirmation({
 ...
 <div className="bg-muted border border-white/10 rounded-xl p-5 space-y-4">
 {/* Carrier */}
 ...
 <Button
 onClick={onConfirm}
 className="flex-1 bg-primary hover: hover:"
 >
