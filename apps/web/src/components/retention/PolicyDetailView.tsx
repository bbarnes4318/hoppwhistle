...
const getStatusConfig = (status: PolicyStatus) => {
  switch (status) {
    case 'SUBMITTED':
      return {
        label: 'Submitted',
        color: 'bg-ringing-tint text-ringing-ink border-ringing/40',
        icon: Clock,
      };
    case 'UW_REVIEW':
      return {
    ...
    case 'ISSUED':
      return {
        label: 'Issued',
        color: 'bg-money-tint text-money-ink border-money/40',
        icon: FileText,
      };
    case 'PAID':
      return {
        label: 'Paid',
        color: 'bg-live-tint text-live-ink border-live/40',
        icon: CheckCircle,
      };
    case 'DECLINED':
      return {
        label: 'Declined',
        color: 'bg-dropped-tint text-dropped-ink border-dropped/40',
        icon: XCircle,
      };
    case 'NOT_TAKEN':
      return {
        label: 'Not Taken',
        color: 'bg-sunken text-ink-3 border-rule',
        icon: XCircle,
      };
    case 'LAPSED':
      return {
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-3 pt-4 border-t">
                {notes.length === 0 ? (
                  ...
                  notes.map(note => (
                    <div key={note.id} className="p-3 rounded-lg bg-sunken border border-border">
        ...
        <div className="space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              {policy.onboardingAttempts >= 7 && (
                <div className="p-3 rounded-lg bg-dropped-tint border border-dropped/40">
                  <p className="text-sm text-dropped-ink font-medium">
          ...
          <Card>
            ...
            <CardContent className="space-y-2">
              ...
              <Button
                variant="outline"
                className="w-full justify-start gap-2 text-live-ink hover:text-live-ink"
              >
              ...
              <Button
                variant="outline"
                className="w-full justify-start gap-2 text-dropped-ink hover:text-dropped-ink"
              >
