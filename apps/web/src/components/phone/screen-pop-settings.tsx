    ...
    >
      ...
      >
        ...
        <div className="px-6 py-4 border-b border-rule flex items-center justify-between">
          <div>
            <h2 className="text-ink text-lg font-semibold">Screen Pop Settings</h2>
                ...
                return (
                  <div
                    ...
                    className={cn(
                      ...
                      'hover:bg-rule hover:border-rule',
                  ...
                  >
                    ...
                    <div
                      className={cn(
                        ...
                        field.enabled ? 'bg-brand-tint text-brand-ink' : 'bg-sunken text-ink-3'
                      )}
                    >
                    ...
                    {/* Label */}
                    <span
                      className={cn('flex-1 text-sm', field.enabled ? 'text-ink' : 'text-ink-3')}
                    >
                      {field.label}
                    </span>
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        field.enabled ? 'bg-brand' : 'bg-sunken'
                      )}
                    >
                      <div
                        className={cn(
        ...
        {/* Preview */}
        <div className="px-6 py-3 bg-sunken border-t border-rule">
          <p className="text-ink-3 text-xs mb-2">Preview:</p>
          <div className="flex flex-wrap gap-2">
            {localFields
              ...
              .map(field => (
                <span
                  key={field.id}
                  className="px-2 py-1 bg-brand-tint text-brand-ink text-xs rounded-full border border-brand/40"
                >
                  {field.label}
                </span>
              ))}
        ...
        <div className="px-6 py-4 border-t border-rule flex items-center justify-between">
          <Button variant="ghost" onClick={handleReset} className="text-ink-3 hover:text-ink gap-2">
