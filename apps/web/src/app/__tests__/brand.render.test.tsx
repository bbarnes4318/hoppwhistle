...
/**
 * The brand mark is the supplied artwork, and the dark scope is an attribute.
 *
 ...
 */
describe('the lockup', () => {
  it('renders the supplied artwork, not text set in a font', () => {
    const { container } = render(<Logo />);
    const img = container.querySelector('[data-testid="logo"] img');
    expect(img?.getAttribute('src')).toBe('/netenroll-logo.png');
