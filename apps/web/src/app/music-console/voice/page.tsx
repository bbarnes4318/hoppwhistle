      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-2 border-b border-[var(--m-border-2)] pb-2 mb-1">
        <div>
          <h1 className="text-lg font-black tracking-tight flex items-center gap-2 text-[var(--m-text)] uppercase">
            <Volume2 className="h-4.5 w-4.5 text-[var(--m-accent)] animate-pulse" /> RPS Voice Engine
          </h1>
        ...
        <div className="flex flex-wrap items-center gap-2 text-[10px]">
          <div className="flex items-center gap-1 px-2 py-0.5 bg-[var(--m-surface-3)] border border-[var(--m-border)] rounded">
            <span className="text-[var(--m-muted)] uppercase tracking-wider font-bold">Voice Persona:</span>
            <span className="text-[var(--m-text)] font-bold font-mono">
              {selectedPersona === 'sarah' ? (engineInfo?.name || 'Sarah (Studio Voice)') : selectedPersona === 'marcus' ? 'Marcus (Studio Voice)' : 'Brian (Studio Voice)'}
            </span>
          </div>
          <div className="flex items-center gap-1.5 px-2 py-0.5 bg-emerald-50 border border-emerald-250 rounded text-emerald-700 font-semibold">
            <span className="h-1.5 w-1.5 rounded-full bg-emerald-600 animate-pulse" />
            <span className="uppercase tracking-wider">Provider Sync: Connected</span>
          </div>
          <div className="flex items-center gap-1 px-2 py-0.5 bg-[var(--m-surface-3)] border border-[var(--m-border)] rounded">
            <span className="text-[var(--m-muted)] uppercase tracking-wider font-bold">Active Station:</span>
            <span className="text-[var(--m-text)] font-bold">Demo Label / Nona Ray</span>
          </div>
          <button
