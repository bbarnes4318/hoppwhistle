          ...
          <div key={step.id} className="flex items-center">
            ...
            <button
              ...
              className={cn(
                ...
                isComplete && !isActive && 'border-live bg-live text-ink',
                !isComplete &&
                  !isActive &&
            ...
            >
              ...
              {step.hasWarning && !isComplete && (
                <span className="absolute -top-1 -right-1 flex h-4 w-4 items-center justify-center rounded-full bg-ringing text-ink">
            ...
            <span
              className={cn(
                ...
                isComplete && !isActive && 'text-live-ink',
