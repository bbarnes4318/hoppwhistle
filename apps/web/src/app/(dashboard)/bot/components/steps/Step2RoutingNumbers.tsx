        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-2">
            <Label htmlFor="transfer-number" className="flex items-center gap-2">
              <PhoneForwarded className="h-4 w-4 text-live-ink" />
            ...
            <Input
              ...
              className={`max-w-md ${transferPhoneNumber && !isTransferValid ? 'border-dropped focus-visible:ring-dropped' : ''}`}
            />
            {transferPhoneNumber && !isTransferValid ? (
              <p className="text-sm text-dropped-ink">
          ...
          <div className="space-y-2">
            <Label htmlFor="caller-id" className="flex items-center gap-2">
              <Phone className="h-4 w-4 text-money-ink" />
              Outbound Caller ID
            </Label>
            <Select
      ...
      <Card>
        ...
        <CardContent>
          <div className="flex items-center justify-center gap-4 py-6">
            ...
            {/* Qualification */}
            <div className="flex flex-col items-center gap-2">
              <div className="flex h-16 w-16 items-center justify-center rounded-full bg-ringing-tint text-ringing-ink">
            ...
            {/* Transfer */}
            <div className="flex flex-col items-center gap-2">
              <div className="flex h-16 w-16 items-center justify-center rounded-full bg-live-tint text-live-ink">
