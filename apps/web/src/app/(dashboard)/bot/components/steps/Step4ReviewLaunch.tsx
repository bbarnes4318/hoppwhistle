  ...
  return (
    <div className="space-y-6">
      ...
      <div className="text-center py-4">
        <h2 className="text-2xl font-bold text-live-ink">Ready to Launch</h2>
      ...
      <div className="grid grid-cols-3 gap-4 p-4 rounded-lg bg-sunken border">
      ...
      <Card>
        ...
        <CardContent>
          ...
          <div className="space-y-4">
            {/* Step 1 Check */}
            <div
              className="flex items-center justify-between p-4 rounded-lg border cursor-pointer hover:bg-sunken transition-colors"
              onClick={() => onGoToStep(1)}
            >
              <div className="flex items-center gap-3">
                {stepStatuses.step1.complete ? (
                  <CheckCircle className="h-5 w-5 text-live-ink" />
                ) : (
                  <AlertTriangle className="h-5 w-5 text-ringing-ink" />
                )}
                <div>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        {allWarnings.length > 0 && (
          <Card className="border-ringing/40">
            <CardHeader>
              <CardTitle className="text-base flex items-center gap-2 text-ringing-ink">
            ...
            <CardContent>
              <ul className="space-y-2">
                {allWarnings.map((warning, i) => (
                  <li key={i} className="flex items-start gap-2 text-sm text-ringing-ink">
                    <span>•</span>
                    {warning}
                  </li>
                ))}
      ...
      <div className="flex justify-between items-center pt-4">
        ...
        <Button
          ...
          disabled={!isReady}
          size="lg"
          className="gap-2 bg-brand hover:bg-brand-ink hover:text-surface px-8"
        >
