    ...
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent>
              ...
              <button
                ...
                className={cn(
                  ...
                  selectedVoice === voice.id
                    ...
                    : 'border-muted hover:border-primary/50 hover:bg-sunken'
                )}
              >
                <div
                  className={cn(
          ...
          {/* Preview Button */}
          {selectedVoiceData && (
            <div className="mt-6 flex items-center gap-4 p-4 rounded-lg bg-sunken">
              <div
                className={cn(
              ...
              {hasPreviewedVoice && <CheckCircle className="h-5 w-5 text-live-ink shrink-0" />}
            </div>
          )}
        </CardContent>
      </Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            ...
            <Button
              ...
              className={saveSuccess ? 'bg-live hover:opacity-90' : ''}
            >
              {isSaving ? (
                <Loader2 className="mr-2 h-4 w-4 animate-spin" />
              ) : saveSuccess ? (
