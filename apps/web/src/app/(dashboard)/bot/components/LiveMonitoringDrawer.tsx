  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-40 bg-background border-t shadow-lg">
      ...
      <button
        ...
        className="w-full flex items-center justify-between px-6 py-3 hover:bg-sunken transition-colors"
      >
        ...
        <div className="px-6 pb-4">
          {activeCalls === 0 && completedCalls === 0 ? (
            ...
            <div className="grid gap-4 md:grid-cols-4">
              {/* Active Calls */}
              <Card className="border-l-4 border-l-money">
                <CardContent className="p-4">
                  <div className="flex items-center justify-between">
                    ...
                    <PhoneCall className="h-8 w-8 text-money-ink opacity-50" />
                  </div>
                </CardContent>
              </Card>

              {/* Completed */}
              <Card className="border-l-4 border-l-live">
                <CardContent className="p-4">
                  <div className="flex items-center justify-between">
                    <div>
                    ...
                    <CheckCircle className="h-8 w-8 text-live-ink opacity-50" />
                  </div>
                </CardContent>
              </Card>

              {/* Remaining */}
              <Card className="border-l-4 border-l-ringing">
                <CardContent className="p-4">
                  <div className="flex items-center justify-between">
                    <div>
                    ...
                    <Clock className="h-8 w-8 text-ringing-ink opacity-50" />
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="border-l-4 border-l-brand">
                <CardContent className="p-4">
                  <div className="flex items-center justify-between">
                    ...
                    <TrendingUp className="h-8 w-8 text-brand-ink opacity-50" />
                  </div>
                </CardContent>
              </Card>
            </div>
