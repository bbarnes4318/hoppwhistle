    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-md">
        ...
        <div className="space-y-4 py-4">
          {/* Summary */}
          <div className="rounded-lg bg-sunken p-4 space-y-2 text-sm">
          ...
          <div className="flex items-start gap-3 p-3 rounded-lg border border-ringing/40 bg-ringing-tint">
            <Checkbox
              id="confirm-launch"
              checked={confirmed}
            ...
            <label
              ...
              className="text-sm font-medium text-ringing-ink cursor-pointer"
            >
        ...
        <DialogFooter className="gap-2 sm:gap-0">
          ...
          <Button
            ...
            disabled={!confirmed}
            className="bg-brand text-brand-fg hover:bg-brand-ink hover:text-surface disabled:opacity-50"
          >
            Start Calling
          </Button>
        </DialogFooter>
