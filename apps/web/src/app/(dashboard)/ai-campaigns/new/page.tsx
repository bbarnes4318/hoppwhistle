...
const CARRIER_INFO: Record<VoipCarrier, { name: string; description: string; badge: string }> = {
  bulkvs: {
                ...
                return (
                  ...
                  >
                    <CardHeader className="pb-3">
                      <div
                        className={`w-12 h-12 rounded-xl ${info.color} flex items-center justify-center mb-3`}
                      >
                  ...
                  ([key, info]) => (
                    ...
                    >
                      <div className="flex items-start gap-3">
                        ...
                        >
                          {carrier === key && <div className="w-1.5 h-1.5 rounded-full bg-white" />}
                        </div>
            ...
            <CardContent>
              <div className="grid grid-cols-2 gap-3 text-sm">
                ...
                <div className="font-medium flex items-center gap-1.5">
                  {carrier === 'signalwire' ? (
                    <Radio className="h-3.5 w-3.5 text-live-ink" />
                  ) : (
