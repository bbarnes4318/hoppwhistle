...
const statusColors: Record<string, string> = {
  ...
  RUNNING: 'bg-live-tint text-live-ink border-live/40',
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-4">
        <Card className="bg-live-tint border-live/40">
          <CardHeader className="pb-2">
            <CardDescription>Running</CardDescription>
            <CardTitle className="text-2xl text-live-ink">
              {campaigns.filter(c => c.status === 'RUNNING').length}
            </CardTitle>
          </CardHeader>
        </Card>
        <Card className="bg-money-tint border-money/40">
          <CardHeader className="pb-2">
            <CardDescription>Ready</CardDescription>
            <CardTitle className="text-2xl text-money-ink">
              {campaigns.filter(c => c.status === 'READY').length}
            </CardTitle>
          </CardHeader>
        </Card>
        <Card className="bg-ringing-tint border-ringing/40">
          <CardHeader className="pb-2">
            <CardDescription>Paused</CardDescription>
            <CardTitle className="text-2xl text-ringing-ink">
              {campaigns.filter(c => c.status === 'PAUSED').length}
            </CardTitle>
          </CardHeader>
        </Card>
        <Card className="bg-sunken border-rule">
          <CardHeader className="pb-2">
            <CardDescription>Completed</CardDescription>
            <CardTitle className="text-2xl text-ink-2">
